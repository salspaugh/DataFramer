    ...
    function d3_fisheye_scale_ordinal(scale, d, a) {
        ...
        fisheye.rangeBands = function (x, padding, outerPadding) {
            var bands = arguments.length === 3 ? scale.rangeBands(x, padding, outerPadding) : arguments.length === 2 ? scale.rangeBands(x, padding) : scale.rangeBands(x);
            fisheye.padding = padding * scale.rangeBand();
            fisheye.outerPadding = outerPadding;
            return fisheye;
        };
